...
/// Former telemetry emitter. Telemetry removed from this build: no-op,
/// sends nothing to any product-events endpoint or analytics service.
pub async fn track(
    _event_name: &str,
    _request_id: &str,
    _ctx: &UserContext,
...
/// Former Mixpanel profile sync. Telemetry removed from this build: no-op,
/// sends nothing.
pub fn sync_profile() {}
