...
/// routing slug (e.g. "Auto" and "Your Own AI Build" both route to `grok-build`)
...
mod tests {
    ...
    fn build_prefetched_map_distinct_ids_same_slug() {
        let entries = vec![
            ...
            make_entry_config_with_id(Some("grok-build"), "grok-build", Some("Your Own AI Build")),
