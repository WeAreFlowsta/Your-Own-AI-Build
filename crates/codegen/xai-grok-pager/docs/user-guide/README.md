...
Customize and extend Your Own AI Build.
...
Automate, script, and integrate Your Own AI Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `your-own-ai-build -p`, output formats, CI/CD integration, and piping |
