...
/// Your Own AI Build + plan mode toolset.
///
...
/// Your Own AI Build + plan mode toolset WITHOUT subagent tools.
///
...
/// Default Your Own AI Build toolset + `ask_user_question`.
///
...
impl AgentDefinition {
    ...
    pub fn default_grok_build() -> Self {
        Self::base(
            ...
            "Your Own AI Build agent for software engineering tasks.",
        )
    }
    /// Your Own AI Build Concise agent definition — concise output format for SFT/RL.
    pub fn grok_build_concise() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Your Own AI Build agent with concise output format.",
            )
        }
    }
    /// Your Own AI Build agent with plan mode tools.
    pub fn grok_build_plan() -> Self {
        Self {
            tool_config: grok_build_plan_toolset(),
            ..Self::base(
                BuiltinAgentName::GrokBuildPlan,
                "Your Own AI Build agent with plan mode support.",
            )
        }
    }
    /// Your Own AI Build + plan mode WITHOUT subagent tools.
    pub fn grok_build_plan_no_subagents() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Your Own AI Build agent with plan mode (no subagents).",
            )
        }
    }
    /// Default Your Own AI Build agent with the `ask_user_question` tool.
    pub fn grok_build_ask_user() -> Self {
        Self {
            tool_config: grok_build_ask_user_toolset(),
            ..Self::base(
                BuiltinAgentName::GrokBuildAskUser,
                "Your Own AI Build agent with ask-user-question tool.",
            )
        }
    }
    pub fn codex() -> Self {
    ...
    /// Your Own AI Build Orchestrator — GBL model with full GrokBuild tools
